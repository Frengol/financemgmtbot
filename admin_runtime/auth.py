...
ADMIN_AUTH_RATE_LIMIT = 60
ADMIN_AUTH_RATE_WINDOW_SECONDS = 60
...
def autenticar_admin_request():
    ...
    auth_shape = "bearer" if bearer_token else "missing_or_malformed"
    limited = rate_limited(
        "admin-auth",
        f"{remote_addr or 'unknown'}:{auth_shape}",
        limit=ADMIN_AUTH_RATE_LIMIT,
        window_seconds=ADMIN_AUTH_RATE_WINDOW_SECONDS,
