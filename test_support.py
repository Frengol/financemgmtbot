...
def auth_test_database_mode_enabled():
    return auth_test_mode_enabled() and (os.environ.get("AUTH_TEST_DATA_SOURCE") or "").strip().lower() == "database"
...
def auth_test_seeded_mode_enabled():
    ...
    configured_source = (os.environ.get("AUTH_TEST_DATA_SOURCE") or "").strip().lower()
    if configured_source:
        return configured_source != "database"
