  ...
  webServer: [
    {
      ...
      env: {
        ...
        TELEGRAM_TASKS_PROJECT: 'financemgmtbot-test',
        TELEGRAM_TASKS_LOCATION: 'southamerica-east1',
        TELEGRAM_TASKS_QUEUE: 'telegram-updates-test',
        TELEGRAM_WORKER_URL: 'https://worker.example.run.app',
        TELEGRAM_TASK_INVOKER_SERVICE_ACCOUNT: 'task-invoker@financemgmtbot-test.iam.gserviceaccount.com',
