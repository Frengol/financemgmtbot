...
import { CopyPlus, LayoutDashboard, History, CheckSquare, Activity, LogOut, Menu, Repeat, X } from "lucide-react";
...
export default function MainLayout() {
  ...
  const menu = [
    ...
    { name: "Despesas recorrentes", path: "/despesas-recorrentes", icon: Repeat },
  ];
