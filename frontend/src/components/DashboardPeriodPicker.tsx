  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        ...
        >
          <div role="tablist" aria-label="Filtro de período da dashboard" className="mb-4 grid grid-cols-2 gap-2 rounded-2xl bg-slate-100 p-1">
            <button
              type="button"
              role="tab"
          ...
          {activeTab === 'range' && (
            <div className="mb-4 grid grid-cols-2 gap-2">
              ...
              >
                <span className="block text-[11px] uppercase tracking-wide opacity-80">Início</span>
