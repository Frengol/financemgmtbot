...
- If docs mention `SUPABASE_GASTOS_TABLE`, keep it as a placeholder/example and never publish internal QA table naming that exposes operational structure you do not want public.
